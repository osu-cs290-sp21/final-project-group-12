...
templates['cartitem'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<section class=\"cartItem-container\" id=\"cartItem-container\">\r\n\r\n    <div class=\"cart-img-container\" >\r\n        <img class=\"cart-item-img\" id=\"cart-item-img\" src=\""
    ...
    + "\"/>\r\n    </div>\r\n    \r\n    <div class=\"cart-description\" >\r\n        <p class=\"cart-item-title\" id=\"cart-item-title\">\r\n            "
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"priceUnit") || (depth0 != null ? lookupProperty(depth0,"priceUnit") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"priceUnit","hash":{},"data":data,"loc":{"start":{"line":28,"column":12},"end":{"line":28,"column":25}}}) : helper)))
    + "\r\n        </p>\r\n    </div>\r\n\r\n    <div>\r\n        <p class=\"cart-item-quantity\" id=\"cart-item-quantity\"></p>\r\n        "
    + alias4(((helper = (helper = lookupProperty(helpers,"amount") || (depth0 != null ? lookupProperty(depth0,"amount") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"amount","hash":{},"data":data,"loc":{"start":{"line":34,"column":8},"end":{"line":34,"column":18}}}) : helper)))
    + "\r\n    </div>\r\n            <!-- <label for=\"item-quantity\">adjust quantity</label> -->\r\n            <select id=\"cart-item-quantity\" class=\"cart-item-quantity\">\r\n              <option value=\"\" selected disabled hidden>"
    + alias4(((helper = (helper = lookupProperty(helpers,"amount") || (depth0 != null ? lookupProperty(depth0,"amount") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"amount","hash":{},"data":data,"loc":{"start":{"line":38,"column":56},"end":{"line":38,"column":66}}}) : helper)))
    + "</option>\r\n              <option>1</option>\r\n              <option>2</option>\r\n              <option>3</option>\r\n            </select>\r\n            <!-- <label for=\"item-img\"></label> -->\r\n            <!--<button type=\"submit\" value=\"Submit\" id=\"adjust-submit-button\" class=\"adjust-submit-button\">adjust quantity</button>-->\r\n            <button type=\"suvmit\" value=\"submit\" id=\"delete-submit-button\" class=\"delete-submit-button\">delete item</button>\r\n</section>";
},"useData":true});
})();